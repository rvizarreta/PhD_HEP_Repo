...
${CMTROOT}/mgr/cmt setup -sh -pack=RockMuonCalibration -version=${MINERVA_RELEASE} -path=/minerva/app/users/rvizarr/cmtuser/Minerva_v22r1p1_2x2/Cal  -no_cleanup $* >${tempfile}; . ${tempfile}
/bin/rm -f ${tempfile}
