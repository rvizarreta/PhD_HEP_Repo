...
${CMTROOT}/mgr/cmt cleanup -csh -pack=RockMuonCalibration -version=${MINERVA_RELEASE} -path=/minerva/app/users/rvizarr/cmtuser/Minerva_v22r1p1_2x2/Cal $* >${tempfile}; source ${tempfile}
/bin/rm -f ${tempfile}
