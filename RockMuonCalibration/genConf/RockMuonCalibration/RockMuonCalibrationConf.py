#Mon Jun 19 13:41:54 2023"""Automatically generated. DO NOT EDIT please"""
from GaudiKernel.Proxy.Configurable import *

class MuonFuzzStudyAlg( ConfigurableAlgorithm ) :
  __slots__ = { 
    'OutputLevel' : 0, # int
    'Enable' : True, # bool
    'ErrorMax' : 1, # int
    ...
    'OutputFilename' : 'nt.root', # str
    'MuonSpeed' : 300.00000000, # float
    'MCHitsLocation' : 'MC/ID/Hits', # str
  ...
  def __init__(self, name = Configurable.DefaultName, **kwargs):
      super(MuonFuzzStudyAlg, self).__init__(name)
      for n,v in kwargs.items():
         setattr(self, n, v)
  def getDlls( self ):
      return 'RockMuonCalibration'
  def getType( self ):
      return 'MuonFuzzStudyAlg'
  pass # class MuonFuzzStudyAlg

class PlexWriterAlg( ConfigurableAlgorithm ) :
  __slots__ = { 
    'OutputLevel' : 0, # int
    'Enable' : True, # bool
    'ErrorMax' : 1, # int
  ...
  def __init__(self, name = Configurable.DefaultName, **kwargs):
      super(PlexWriterAlg, self).__init__(name)
      for n,v in kwargs.items():
         setattr(self, n, v)
  def getDlls( self ):
      return 'RockMuonCalibration'
  def getType( self ):
      return 'PlexWriterAlg'
  pass # class PlexWriterAlg

class RockMuonCalibrationAlg( ConfigurableAlgorithm ) :
  __slots__ = { 
    'OutputLevel' : 0, # int
    'Enable' : True, # bool
    'ErrorMax' : 1, # int
    ...
    'EvtColDir' : 'DefaultName', # str
    'OutputFilename' : 'nt.root', # str
    'TimeFilename' : 'time.txt', # str
    'WriteTimeFile' : False, # bool
    'WriteHitStuff' : True, # bool
    'AllowMinosStub' : False, # bool
    'MCHitsLocation' : 'MC/ID/Hits', # str
    'GenMinInteractionLocation' : 'Gen/Interactions', # str
  }
  _propertyDocDct = { 
  ...
  def __init__(self, name = Configurable.DefaultName, **kwargs):
      super(RockMuonCalibrationAlg, self).__init__(name)
      for n,v in kwargs.items():
         setattr(self, n, v)
  def getDlls( self ):
      return 'RockMuonCalibration'
  def getType( self ):
      return 'RockMuonCalibrationAlg'
  pass # class RockMuonCalibrationAlg
