...
VERBOSETIMECUT = False # whether to print fit parameters
DRAW_TIMEHIST = False # whether to draw the hits as function of time plot
...
class EventLoop(object):
    def __init__(self, ttree_filename, dat_filename, file_mode="RECREATE", tree_name="mwpc"):
    ...
    def loop(self):
        ...
        with open(self.dat_filename) as f:
            ...
            # finally process the final event
            self.process_event() 
        self.afterread()
        self.finalizeloop()
    ...
    def save_(self):
        ...
        for event in self.events:
            ...
            # store the clusters
            clusters = list(itertools.chain(*event.clusters.values()))
