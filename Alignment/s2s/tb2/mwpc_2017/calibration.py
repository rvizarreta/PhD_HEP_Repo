...
CALTOUSE = "CaliAuto10x" #"Cali3x" #"Survey"#"CaliAuto10x"#"Cali3x"#"None"
...
MINGOODNESSFORTRACK = 1

CONSERVATIVETRACKFINDING = False
COMBINETIMECUTS = True
...
elif CALTOUSE == "None" or CALTOUSE == None:
    hitoffsets = {
    (1,0): 0,
    (1,1): 0,
    (2,0): 0,
...
elif CALTOUSE == "8GeVPosPionAuto":  # using run 1's /minerva/data/testbeam2/run1data_newmwpc/8GeV_Pos_Pions/TB_00001461_*mwpc.root
    hitoffsets = {(1, 0): 0.0,
     (1, 1): 0.0,
     (2, 0): 8.5480319044066988,
     (2, 1): 1.2959408564228454,
     (3, 0): 9.1328010412968474,
     (3, 1): -0.66737432203212421,
     (4, 0): 7.875966154438494,
     (4, 1): 0.90718031187061854}
elif CALTOUSE == "8GeVPosPionAutoRun2":  # using run 2's /minerva/data/testbeam2/rawdata/testbeam/raw/cosmc/00/00/15/14/TB_00001514_00*mwpc.dat, 8 GeV pion, 10 iterations, only 10 files
    hitoffsets = {(1, 0): 0.0,
     (1, 1): 0.0,
     (2, 0): 8.6219166283630102,
     (2, 1): 1.5639530038386589,
     (3, 0): 9.1342984637447238,
     (3, 1): -0.64358814520249685,
     (4, 0): 9.4901332347043006,
     (4, 1): 1.0968515947918165}
     
def getoffset(key):
    return hitoffsets[(1, key[1])]-hitoffsets[key]

def updateoffsets(newoffsets, factor=1):
    for key in newoffsets:
        hitoffsets[key] += newoffsets[key] * factor
...
angleoffsets = {(1, 0): (0.45427266002095451,
